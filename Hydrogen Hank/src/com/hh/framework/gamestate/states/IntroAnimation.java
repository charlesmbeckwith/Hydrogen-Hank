...
public class IntroAnimation extends GameState {
	...
	public IntroAnimation() {
		...
		handler.addObject(new Cloud(100, 100, 256, 128, new Vector2D(0, 0),
				true));
		handler.addObject(new Cloud(450, 225, 256, 128, new Vector2D(0, 0),
				true));
		handler.addObject(new Cloud(600, 300, 256, 128, new Vector2D(0, 0),
				true));
		handler.addObject(new Cloud(800, 510, 256, 128, new Vector2D(0, 0),
				true));
		handler.addObject(new Cloud(250, 430, 256, 128, new Vector2D(0, 0),
				true));
	}
	...
	private void drawRedTint(Graphics2D g) {
		...
		g2d.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,
				0.3f));
		g2d.fillRect(0, Game.HEIGHT / 2 - redBoxHeight, Game.WIDTH,
				redBoxHeight * 2);
	}
